...
// For example, given ["apple","rottenBanana","apple"] the replaced array
//  should be ["apple","banana","apple"]. 
...
const removefunc = arr => {
    ...
    for(arrays of arr){
        ...
        const isRotten = arrays.startsWith("rotten");
        removeArr.push(isRotten ? arrays.slice(6).toLowerCase() : arrays.toLowerCase() ) 
    }
    return removerArr;
}